...
class LogisticDaerahAdapter (
    private var logisticList: List<Logistic>,
    private val homeDaerahViewModel: HomeDaerahViewModel
) : RecyclerView.Adapter<LogisticDaerahAdapter.ViewHolder>(){
        ...
        init {
            textScore.addTextChangedListener(object : TextWatcher {
                ...
                override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                    ...
                    homeDaerahViewModel.update(item)
                }
